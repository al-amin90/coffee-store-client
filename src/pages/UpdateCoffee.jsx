        ...
        <div style={{ backgroundImage: `url(${banner})`, backgroundRepeat: "no-repeat", backgroundSize: "contain" }}>
            <div className='pb-24 md:w-[80%] px-4 pt-12 mx-auto'>
                ...
                <div className='py-10 px-16 bg-[#F4F3F0] rounded-lg'>
                    <h1 className="mb-5 text-4xl text-[#374151] text-center font-semibold mt-2 font-rancho">Update Existing Coffee Details</h1>
                    ...
                    <form onSubmit={handleUpdate}>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                            <div className="form-control">
                                ...
                                <input type="text" defaultValue={name} name='name' placeholder="Enter coffee name" className="input px-3 py-1" />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text font-semibold text-base">Chef</span>
                                </label>
                                <input type="text" defaultValue={chef} name='chef' placeholder="Enter coffee chef" className="input px-3 py-1" />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text font-semibold text-base">Price</span>
                                </label>
                                <input type="text" defaultValue={price} name='price' placeholder="Enter coffee price" className="input px-3 py-1" />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text font-semibold text-base">Taste</span>
                                </label>
                                <input type="text" defaultValue={taste} name='taste' placeholder="Enter coffee taste" className="input px-3 py-1" />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text font-semibold text-base">Category</span>
                                </label>
                                <input type="text" defaultValue={category} name='category' placeholder="Enter coffee category" className="input px-3 py-1" />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text font-semibold text-base">Details</span>
                                </label>
                                <input type="text" defaultValue={details} name='details' placeholder="Enter coffee details" className="input px-3 py-1" />
                            </div>
                            <div className="form-control col-span-2">
                                <label className="label">
                                    <span className="label-text font-semibold text-base">Photo</span>
                                </label>
                                <input type="text" defaultValue={photo} name='photo' placeholder="Enter photo URL" className="input  px-3 py-1" />
                            </div>
                        </div>
                        <button type="submit" className="py-2 px-5 w-full mt-4 hover:bg-transparent border rounded-md border-[#331A15] bg-[#D2B48C] text-xl text-[#242222] font-rancho">Update Coffee Details</button>
                    </form>
                </div>
            </div>
        </div>
