...
import bottom from "../assets/24.jpg"


const Footer = () => {
    return (
        <div>
            <div className="w-full" style={{ backgroundImage: `url(${footer})`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
                ...
                <div className="min-w-100vw" style={{ backgroundImage: `url(${bottom})`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
                    <h1 className=" text-lg py-2 text-white w-full text-center font-rancho">Copyright Espresso Emporium ! All Rights Reserved</h1>
                </div>
            </div>
